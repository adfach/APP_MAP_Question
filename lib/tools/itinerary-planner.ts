  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        zoomLevel: {
          type: 'STRING',
          description: 'Adjusts the camera zoom level when framing locations without markers. "close" for a tighter view, "medium" for a balanced view (default), or "far" for a wider view.',
